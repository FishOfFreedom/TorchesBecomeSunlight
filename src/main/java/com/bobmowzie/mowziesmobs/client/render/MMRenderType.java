...
/**Be from https://github.com/BobMowzie/MowziesMobs/blob/master/src/main/java/com/bobmowzie/mowziesmobs/client/render/MMRenderType.java
 * @author bobmowzie
 */
@OnlyIn(Dist.CLIENT)
