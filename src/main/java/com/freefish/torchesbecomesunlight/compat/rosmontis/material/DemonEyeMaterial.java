...
public class DemonEyeMaterial extends ShaderInstanceMaterial {
    private static final Map<ResourceLocation, ShaderInstance> COMPILED_SHADERS = new HashMap();
    public ResourceLocation shader = new ResourceLocation("torchesbecomesunlight:demoneye");
    private String compiledErrorMessage = "";
    private Runnable uniformCache = null;

    public DemonEyeMaterial() {
