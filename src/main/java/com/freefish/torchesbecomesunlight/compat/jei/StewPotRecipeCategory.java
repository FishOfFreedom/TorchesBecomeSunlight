...
public class StewPotRecipeCategory implements IRecipeCategory<StewPotRecipe> {
    ...
    public StewPotRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 80);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ItemHandle.STEW_POT.get()));
    }

    @Override
    public RecipeType<StewPotRecipe> getRecipeType() {
        return JeiPlugin.STEW_POT_RECIPE_RECIPE_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("block.torchesbecomesunlight.stew_pot");
    }
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull StewPotRecipe recipe, @Nonnull IFocusGroup focusGroup) {
