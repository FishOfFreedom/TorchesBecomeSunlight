...
public class CuttingBoardRecipeCategory implements IRecipeCategory<CuttingBoardRecipe> {
    ...
    public CuttingBoardRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ItemHandle.CUTTING_BOARD.get()));
    }

    @Override
    public RecipeType<CuttingBoardRecipe> getRecipeType() {
        return JeiPlugin.CUTTING_BOARD_RECIPE_RECIPE_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("block.torchesbecomesunlight.cutting_board");
    }
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull CuttingBoardRecipe recipe, @Nonnull IFocusGroup focusGroup) {
