...
import com.freefish.torchesbecomesunlight.client.render.Item.TimeGunRenderer;
...
public class TimeGun extends Item implements GeoItem {
    private final AnimatableInstanceCache geoCache = GeckoLibUtil.createInstanceCache(this);
    public TimeGun(Properties pProperties) {
        super(pProperties);
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private BlockEntityWithoutLevelRenderer renderer = new TimeGunRenderer();
            @Override
    ...
    public void appendHoverText(ItemStack stack, @org.jetbrains.annotations.Nullable Level level, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("text.torchesbecomesunlight.time"));
    }
            ...
            if(!level.isClientSide){
                ...
                if (entityhitresult != null) {
                    ...
                    if(entity instanceof LivingEntity living){
                        ...
                        ForceEffectHandle.addForceEffect(living,new ForceEffectInstance(ForceEffectHandle.SLOW_MOVE_FORCE_EFFECT,1,20));
                    }
                }
            }
