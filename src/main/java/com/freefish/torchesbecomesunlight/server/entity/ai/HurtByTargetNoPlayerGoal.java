...
public class HurtByTargetNoPlayerGoal extends TargetGoal {
   ...
   public HurtByTargetNoPlayerGoal(PathfinderMob pMob, Class<?>... pToIgnoreDamage) {
      super(pMob, true);
   ...
   public HurtByTargetNoPlayerGoal setAlertOthers(Class<?>... pReinforcementTypes) {
