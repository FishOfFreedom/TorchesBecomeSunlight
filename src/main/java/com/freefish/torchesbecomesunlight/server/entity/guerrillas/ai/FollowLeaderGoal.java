...
public class FollowLeaderGoal<T extends GuerrillasEntity& ITeamMemberStorage<M>,M extends Mob> extends Goal {
    ...
    public FollowLeaderGoal(T pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance) {
    ...
    public boolean canUse() {
        M livingentity = this.tamable.getLeader();

        if (livingentity == null||(livingentity instanceof IChallengeEntity c&&c.getChallenge()!=null)) {
            return false;
