...
public class POIHandle {
    ...
    public static final RegistryObject<PoiType> URSUS_VILLAGE_CENTRE = DEF_REG.register("village_center", () -> new PoiType(getAllStatesOf(BlockHandle.STEW_POT.get()), 0, 6));
