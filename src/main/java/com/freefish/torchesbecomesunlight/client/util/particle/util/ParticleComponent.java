package com.freefish.torchesbecomesunlight.client.util.particle.util;
...
/**Be from https://github.com/BobMowzie/MowziesMobs/blob/master/src/main/java/com/bobmowzie/mowziesmobs/client/particle/util/ParticleComponent.java
 * @author bobmowzie
 */
...
//                particle.roll = (float) Math.PI / 2;
    ...
    public static class LocateEntity extends ParticleComponent {
        Entity locateEntity;
