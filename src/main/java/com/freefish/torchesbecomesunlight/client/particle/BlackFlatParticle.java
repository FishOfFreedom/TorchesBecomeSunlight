...
public class BlackFlatParticle extends TextureSheetParticle {
    ...
    public BlackFlatParticle(ClientLevel level, double x, double y, double z, double toX, double toY, double toZ) {
    ...
    public void tick() {
        super.tick();
        //t/his.setSpriteFromAge(this.sprites);
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            BlackFlatParticle spellparticle = new BlackFlatParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
            spellparticle.pickSprite(sprite);
