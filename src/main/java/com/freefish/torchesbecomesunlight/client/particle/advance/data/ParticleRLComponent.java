...
public abstract class ParticleRLComponent {
    public ParticleRLComponent() {

    }

    public void init(AdvancedRLParticleBase particle) {

    }

    public void preUpdate(AdvancedRLParticleBase particle) {

    }

    public void postUpdate(AdvancedRLParticleBase particle) {

    }

    public void preRender(AdvancedRLParticleBase particle, float partialTicks) {

    }

    public void postRender(AdvancedRLParticleBase particle, VertexConsumer buffer, Camera renderInfo, float partialTicks, int lightmap) {
    ...
    public static class KeyTrack extends AnimData {
        ...
        public static KeyTrack easeInCubic(float startValue, float endValue) {
            ...
            for(int i = 0;i<11;i++){
                f1[i] = f2[i]*f2[i]*f2[i]*value + startValue;
            }
    ...
    public static class PropertyControl extends ParticleRLComponent {
        ...
        private void applyUpdate(AdvancedRLParticleBase particle, float value) {
        ...
        private void applyRender(AdvancedRLParticleBase particle, float value) {
    ...
    public static class PinLocation extends ParticleRLComponent {
    ...
    public static class Attractor extends ParticleRLComponent {
    ...
    public static class Orbit extends ParticleRLComponent {
        private final Vec3[] location;
        ...
        private void apply(AdvancedRLParticleBase particle, float t) {
    ...
    public static class FaceMotion extends ParticleRLComponent {
        public FaceMotion() {
...
//                particle.roll = (float) Math.PI / 2;
    ...
    public static class LocateEntity extends ParticleRLComponent {
        Entity locateEntity;
        public LocateEntity(Entity entity) {
        ...
        public void preRender(AdvancedRLParticleBase particle, float partialTicks) {
            super.preRender(particle, partialTicks);
            particle.setPos(locateEntity.getX(), locateEntity.getY(), locateEntity.getZ());
        }
    }
}
