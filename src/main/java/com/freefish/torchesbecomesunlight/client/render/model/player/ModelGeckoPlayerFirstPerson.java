package com.freefish.torchesbecomesunlight.client.render.model.player;
...
public class ModelGeckoPlayerFirstPerson extends MowzieGeoModel<GeckoPlayer> {
	...
	public ResourceLocation getAnimationResource(GeckoPlayer animatable) {
		return new ResourceLocation(TorchesBecomeSunlight.MOD_ID, "animations/animated_player_first_person.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(GeckoPlayer animatable) {
		return new ResourceLocation(TorchesBecomeSunlight.MOD_ID, "geo/animated_player_first_person.geo.json");
	}
