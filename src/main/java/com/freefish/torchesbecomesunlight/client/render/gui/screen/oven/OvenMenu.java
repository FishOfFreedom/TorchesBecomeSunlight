package com.freefish.torchesbecomesunlight.client.render.gui.screen.oven;

import com.freefish.torchesbecomesunlight.TorchesBecomeSunlight;
import com.freefish.torchesbecomesunlight.server.block.blockentity.OvenBlockEntity;
...
public class OvenMenu extends RecipeBookMenu<RecipeWrapper> {
    ...
    public OvenMenu(final int windowId, final Inventory playerInventory, final OvenBlockEntity blockEntity, ContainerData cookingPotDataIn) {
        super(MenuHandle.OVEN_MENU.get(), windowId);
        ...
        // Output
        this.addSlot(new OvenResultSlot(playerInventory.player, blockEntity, inventory, 12, 124, 35));
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(canInteractWithCallable, playerIn, BlockHandle.OVEN.get());
    }
