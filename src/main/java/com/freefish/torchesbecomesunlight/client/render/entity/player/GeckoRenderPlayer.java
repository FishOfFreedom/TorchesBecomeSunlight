...
import com.freefish.torchesbecomesunlight.client.render.model.player.ModelPlayerAnimated;
...
public class GeckoRenderPlayer extends PlayerRenderer implements GeoRenderer<GeckoPlayer> {
    ...
    public GeckoRenderPlayer(EntityRendererProvider.Context context, boolean slim, ModelGeckoPlayerThirdPerson geoModel) {
        ...
        this.layers.clear();
        this.addLayer(new GeckoArmorLayer<>(this, new ModelBipedAnimated<>(context.bakeLayer(slim ? ModelLayers.PLAYER_SLIM_INNER_ARMOR : ModelLayers.PLAYER_INNER_ARMOR)), new ModelBipedAnimated<>(context.bakeLayer(slim ? ModelLayers.PLAYER_SLIM_OUTER_ARMOR : ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager(),geoModel));
