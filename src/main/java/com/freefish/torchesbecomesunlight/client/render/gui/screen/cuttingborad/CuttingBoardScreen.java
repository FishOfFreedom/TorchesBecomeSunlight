...
import com.freefish.torchesbecomesunlight.client.render.gui.screen.stewpot.CookingPotRecipeBookComponent;
...
public class CuttingBoardScreen extends AbstractContainerScreen<CuttingBoardMenu> implements RecipeUpdateListener {
    ...
    public CuttingBoardScreen(CuttingBoardMenu screenContainer, Inventory inv, Component titleIn) {
    ...
    private void renderHeatIndicatorTooltip(GuiGraphics gui, int mouseX, int mouseY) {
        if (this.isHovering(HEAT_ICON.x, HEAT_ICON.y, HEAT_ICON.width, HEAT_ICON.height, mouseX, mouseY)) {
            ...
            gui.renderTooltip(this.font, Component.literal(""), mouseX, mouseY);
        }
    }
